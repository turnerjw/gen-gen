...
function RootLayout() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* NAV */}
      <header className="fixed left-0 right-0 top-0 z-40 flex h-[52px] items-center justify-between border-b-[1px] border-background bg-foreground">
      ...
      <footer className="flex items-end justify-between border-t-[1px] border-background bg-foreground px-10 py-8">
        <div>
          ...
          <p className="mt-2 text-[11px] uppercase tracking-[0.15em] text-[#555]">Type-safe test factory generator</p>
        </div>
        <div className="flex gap-6">
          <a href="https://github.com/justinturner/gen-gen" target="_blank" rel="noreferrer" className="text-[11px] uppercase tracking-[0.1em] text-[#666] no-underline transition-colors hover:text-primary">GitHub</a>
          <a href="https://www.npmjs.com/package/gen-gen" target="_blank" rel="noreferrer" className="text-[11px] uppercase tracking-[0.1em] text-[#666] no-underline transition-colors hover:text-primary">npm</a>
        </div>
      </footer>
