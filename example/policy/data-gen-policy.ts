import type {PolicyExample} from "./policy-types";
...
export type GeneratePolicyExampleCallbackParam = (helpers: GenGenHelpers<PolicyExample>) => Partial<PolicyExample>;

export function generatePolicyExample(overrides?: Partial<PolicyExample> | GeneratePolicyExampleCallbackParam): PolicyExample {
  const base: PolicyExample = {
    id: faker.word.noun(),
    createdAt: faker.word.noun(),
