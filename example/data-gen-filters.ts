...
export type GenerateProfileCallbackParam = (helpers: GenGenHelpers<Profile>) => Partial<Profile>;

export function generateProfile(overrides?: Partial<Profile> | GenerateProfileCallbackParam): Profile {
  const base: Profile = {
...
export type GenerateSessionEnvelopeCallbackParam = (helpers: GenGenHelpers<Envelope<Session>>) => Partial<Envelope<Session>>;

export function generateSessionEnvelope(overrides?: Partial<Envelope<Session>> | GenerateSessionEnvelopeCallbackParam): Envelope<Session> {
  const base: Envelope<Session> = {
