import type {UnionExample} from "./unions-types";
...
export type GenerateUnionExampleCallbackParam = (helpers: GenGenHelpers<UnionExample>) => Partial<UnionExample>;

export function generateUnionExample(overrides?: Partial<UnionExample> | GenerateUnionExampleCallbackParam): UnionExample {
  const base: UnionExample = {
